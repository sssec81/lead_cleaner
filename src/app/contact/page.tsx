...
export default function ContactPage() {
 ...
 {/* Context Card */}
 <div className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-blue-200 hover:bg-white sm:p-10 flex flex-col justify-center">
 ...
 {/* Checklist Grid */}
 <div className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-slate-300 hover:bg-white sm:p-10">
 <h3 className="text-sm font-bold uppercase tracking-widest text-slate-900 mb-8">What to include</h3>
 <div className="grid gap-4 sm:grid-cols-2">
 {messageTips.map((tip) => {
 const Icon = tip.icon;
 return (
 <div key={tip.text} className="flex flex-col gap-3 rounded-xl border border-slate-100 bg-slate-50 p-5 transition-colors hover:bg-blue-50/50 hover:border-blue-100">
 ...
 <div 
 key={item.label}
 className="group relative overflow-hidden rounded-xl border border-white/10 bg-white/5 p-8 transition-all duration-300 hover:-translate-y-2 hover:bg-white/10 hover:shadow-sm"
 >
 ...
 <div className="relative">
 <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-white/10 text-white backdrop-blur-md">
 ...
 className="inline-flex w-full min-h-12 items-center justify-center gap-2 rounded-xl bg-white/10 px-6 text-sm font-semibold text-white transition-all hover:bg-sky-500 hover:shadow-sm"
 >
 {item.cta}

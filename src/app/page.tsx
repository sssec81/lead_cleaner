...
export default function HomePage() {
 ...
 className="group inline-flex min-h-14 items-center justify-center gap-3 rounded-full bg-blue-600 px-8 text-base font-semibold text-white shadow-sm transition-all duration-300 hover:bg-blue-500 hover:shadow-sm hover:-translate-y-0.5"
 >
 Clean a CSV Free
 ...
 <Link
 href="/pricing"
 className="inline-flex min-h-14 items-center justify-center rounded-full border border-slate-200 bg-white px-8 text-base font-semibold text-slate-700 transition-colors hover:border-slate-300 hover:bg-white"
 >
 View limits
 </Link>
 </div>
 ...
 <div className="absolute -inset-4 rounded-xl bg-gradient-to-br from-blue-500/10 to-emerald-500/10 blur-2xl"></div>
 <div className="relative overflow-hidden rounded-xl border border-white/40 bg-white p-6 shadow-sm sm:p-8">
 ...
 return (
 <div key={step.num} className="group relative rounded-xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:shadow-lg hover:border-blue-200 hover:-translate-y-1">
 ...
 return (
 <div key={signal.label} className="group rounded-xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:shadow-sm hover:border-blue-200 hover:-translate-y-1">
 <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-blue-50 text-blue-600 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
 ...
 <Link
 href="/tools/csv-lead-cleaner"
 className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-sky-500 px-8 text-sm font-bold text-slate-950 transition-all hover:bg-sky-400 hover:shadow-sm"
 >
 Clean a CSV Free
 ...
 <div key={step.number} className="group flex gap-8 rounded-xl border border-white/5 bg-white/5 p-8 transition-colors hover:bg-white/10 hover:border-white/10">
...
function WorkspaceRowMock({ index, value, source, locked = false, highlight = false }: any) {
 return (
 <div className={`rounded-xl border bg-white p-4 transition-colors ${highlight ? 'border-amber-200 bg-amber-50/30' : 'border-slate-100'}`}>
...
function UseCaseRow({ kicker, title, text, index, primary = false }: any) {
 return (
 <div className={`group rounded-xl border p-8 transition-all hover:shadow-md ${primary ? 'border-blue-200 bg-white shadow-sm' : 'border-slate-200 bg-white hover:border-slate-300'}`}>
...
function SupportLink({ href, title, text, index }: any) {
 return (
 <Link href={href} className="group rounded-xl border border-slate-200 bg-white p-8 transition-all hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
 <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-slate-50 text-slate-400 transition-colors group-hover:bg-blue-50 group-hover:text-blue-600 font-bold">
 0{index}
 </div>

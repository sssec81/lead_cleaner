...
export default function ConvertCsvToJsonPage() {
 ...
 <Link
 href="#converter"
 className="group inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-blue-600 px-7 text-sm font-semibold text-white shadow-sm transition-all duration-300 hover:bg-blue-500 hover:shadow-sm hover:-translate-y-0.5"
 >
 Convert CSV to JSON
 ...
 <div className="absolute -inset-3 rounded-xl bg-gradient-to-br from-blue-500/8 to-indigo-500/8 blur-xl"></div>
 <div className="relative overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm backdrop-blur-md">

...
export default function ToolsPage() {
 ...
 <div className="rounded-xl border border-blue-100 bg-blue-50/50 p-8 shadow-sm">
 ...
 key={tool.href}
 href={tool.href}
 className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:-translate-y-2 hover:border-slate-300 hover:shadow-sm"
 >
 <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl bg-slate-50 text-slate-600 transition-colors duration-300 group-hover:bg-blue-50 group-hover:text-blue-600">
...
function FlagshipCard({ tool }: { tool: typeof flagshipTools[0] }) {
 ...
 <Link
 href={tool.href}
 className="group relative overflow-hidden rounded-xl bg-slate-950 p-8 shadow-sm transition-all duration-300 hover:shadow-sm sm:p-12"
 >
 ...
 <Link
 href={tool.href}
 className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:border-blue-200 hover:bg-white sm:p-12"
 >

...
export const metadata: Metadata = buildToolMetadata({
 title: "Remove Duplicate Emails Online",
 description:
 "Remove duplicate emails online, keep one clean copy of each address, and export the result locally in your browser. No signup required.",

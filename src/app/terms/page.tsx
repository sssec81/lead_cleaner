    ...
    <PageFrame>
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mt-5 max-w-3xl text-lg leading-8 text-[color:var(--muted)]">
          LeadCleanr is a utility tool for cleaning data, not a guarantee of
          perfect extraction. These terms keep the product focused on legitimate
          cleanup work and set clear expectations about how the MVP should be
          used.
        </p>

...
export function TextToolPageShell({
 ...
 {asideContent ?? (
 <div className="group relative overflow-hidden rounded-xl border border-slate-200 bg-white p-8 shadow-sm transition-all duration-300 hover:bg-white sm:p-10">
 ...
 <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-xl shadow-slate-200/40 sm:p-6 lg:p-8">
 {tool}
 </div>
 {toolSupportingContent ? (

...
export function TextTransformationPreviewCard({
  ...
  return (
    <div className="group rounded-2xl border border-[#E5E7EB] bg-white p-5 shadow-[0_18px_45px_-34px_rgba(15,23,42,0.45)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_24px_56px_-36px_rgba(15,23,42,0.55)] sm:p-6">
      ...
      <div className="overflow-hidden rounded-xl border border-slate-800 bg-[#0B1020]">
        <div className="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-2">
          ...
          <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-emerald-300 transition-shadow duration-200 group-hover:shadow-[0_0_22px_rgba(52,211,153,0.32)]">
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-3">
        {[
          ...
          <div
            key={label}
            className="inline-flex min-h-9 items-center justify-center gap-1.5 rounded-full border border-slate-200 bg-white px-3 text-[11px] font-semibold text-slate-600"
          >

    ...
    <div className="mx-auto w-full max-w-[1200px]">
      <div className="flex flex-col gap-8 xl:flex-row">
        ...
        <div className="flex flex-col min-w-[360px] xl:w-[360px] xl:shrink-0 rounded-[2rem] border border-[color:var(--line)] bg-[color:rgba(255,255,255,0.4)] p-6 sm:p-8 shadow-sm">
          ...
          {rows.length > 0 && (
             <div className="mt-6 rounded-2xl border border-slate-200/60 bg-white/70 p-5 shadow-sm space-y-4">
            ...
            <div className="flex-1 flex flex-col justify-center items-center text-center">
              {rows.length === 0 ? (
                ...
                <div className="w-full flex flex-col items-start text-left">
                  ...
                  <div className="mt-6 w-full rounded-2xl border border-slate-200 bg-slate-50/50 p-6">
                     <h3 className="text-sm font-semibold text-slate-800 mb-4">Export Summary</h3>
                     <ul className="space-y-3 text-sm text-slate-600">
                       <li className="flex items-center justify-between border-b border-slate-200/60 pb-3">

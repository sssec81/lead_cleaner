...
export function ExtractEmailsFromCsvTool() {
 ...
 <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[color:rgba(37,99,235,0.08)] text-[color:#2563eb]">
 ...
 className="group mt-2 flex min-h-[16rem] cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-slate-300 bg-white px-6 py-8 text-center transition-all duration-200 hover:border-blue-500 hover:bg-blue-50/50"
 >
 ...
 <div
 key={item.label}
 className="flex flex-col items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-white px-2 py-3 text-center shadow-sm"
 >
 ...
 <div className="mt-4 rounded-xl border border-[color:var(--line)] bg-slate-50 p-4">
 ...
 className="mt-2 min-h-11 w-full rounded-xl border border-slate-200 bg-slate-50 hover:bg-slate-50 focus:bg-white px-3 text-sm text-slate-800 outline-none focus:border-[color:var(--brand)] focus:ring-2 focus:ring-blue-500/10 transition"
 >
 {headers.map((header) => (
 ...
 <div
 className={`mt-4 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xs flex flex-col ${

...
export function LocalProcessingBadge({
 ...
 className={`inline-flex items-center gap-1.5 rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[11px] font-medium text-slate-600 ${className}`.trim()}
 >
